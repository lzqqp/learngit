...
_IMAGE = _descriptor.Descriptor(
  name='Image',
  full_name='adu.common.sensor.Image',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='adu.common.sensor.Image.header', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='adu.common.sensor.Image.frame_id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='measurement_time', full_name='adu.common.sensor.Image.measurement_time', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height', full_name='adu.common.sensor.Image.height', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='adu.common.sensor.Image.width', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='adu.common.sensor.Image.encoding', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='step', full_name='adu.common.sensor.Image.step', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='adu.common.sensor.Image.data', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disparity_step', full_name='adu.common.sensor.Image.disparity_step', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disparity_data', full_name='adu.common.sensor.Image.disparity_data', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pixel_format', full_name='adu.common.sensor.Image.pixel_format', index=10,
...
_COMPRESSEDIMAGE = _descriptor.Descriptor(
  ...
  full_name='adu.common.sensor.CompressedImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='adu.common.sensor.CompressedImage.header', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='adu.common.sensor.CompressedImage.frame_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='format', full_name='adu.common.sensor.CompressedImage.format', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='adu.common.sensor.CompressedImage.data', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='measurement_time', full_name='adu.common.sensor.CompressedImage.measurement_time', index=4,
...
_IMAGE.fields_by_name['pixel_format'].enum_type = _PIXELFORMAT
_COMPRESSEDIMAGE.fields_by_name['header'].message_type = header__pb2._HEADER
...
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:adu.common.sensor.Image)
  ))
...
CompressedImage = _reflection.GeneratedProtocolMessageType('CompressedImage', (_message.Message,), dict(
  ...
  __module__ = 'sensor_image_pb2'
  # @@protoc_insertion_point(class_scope:adu.common.sensor.CompressedImage)
  ))
